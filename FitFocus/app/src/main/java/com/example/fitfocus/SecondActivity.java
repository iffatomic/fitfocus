...
public class SecondActivity extends AppCompatActivity {
    ...
    private void submitActivity() {
        ...
        int dayCount = sharedPreferences.getInt("day_count", 1);
        ...
        // Increment calories burned (assuming 30 kcal per workout)
        ...
        Intent intent = new Intent(SecondActivity.this, ProgressTrackingActivity.class);
